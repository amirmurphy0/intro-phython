...
# Write your response using complete sentences. Function parameters are the names listed in the function's defintion function arguments are the real value passed to the function

# 2. In your own words, describe what each of the following errors means.
# Write your response using complete sentences.

# syntax error - spelling error
# type error - rejected by the computer
# name error - something needs to be corrected 

# 3. What function would I use if I wanted to convert an integer data type into 
# a string data type? I would use the function str() 

# 4. What function would I use if I wanted to change a float data type into a 
# an integer data type? i would use the function int() 

# 5. Describe three (3) Variable naming rules. Write your response in complete sentences.  An variable must start with a letter.It cannot start with a number.It can can only contain letters nothing else.
...
# Please provide three (3) clues/ keywords and explain why you chose them to get full credit.
          def mph()
              if '20mph' ==: 
             print('the alert would come up switch to gear 1') 
             if '30mph'==: 
             print('the alert would come up switch to gear 2 ')
             if '40mph'==:
             print('alert would come up switch to gear 3')
             if '70mph'==:
             print('alert wwould come up go back to gear 1') 
#I choose these functions because we want the driver to be alerted everytime they go above an gear speed limit too change it too it's right one.
...
# Please provide three (3) clues/ keywords and explain why you chose them to get full credit.
1. 85% overall grade 2. Passed the SAT 3. Academic honors list
