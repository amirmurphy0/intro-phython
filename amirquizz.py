...
#4. What does it mean when you encounter a syntax error? computer doesn't understand

#5. What is a variable? Provide an example of a variable in code. variable is a bunch of numbers 

#6. Write a function in Python that when called will print out 
# your name. use "'" to print out your name

#7. What is a function definition and a function call? A function is called a operator 
