...
'conditional (if/elif/else), function, input'
'user input a value and should be able to go to a floor'
...
if floor == 'b':
       print ('you are going to basement') 
elevator() 

if floor == 'r' :
        print ('you are going to rooftop') 
        elevator() 

  if
floor== '1' :
       print ('you are going to gym')
elevator() 
