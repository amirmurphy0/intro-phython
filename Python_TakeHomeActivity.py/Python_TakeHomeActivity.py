...
# with us. )
def discount_rewards_program():
    #prompt user for input
      name =input("please enter your name")
      tier=input("please enter your membership tier (gold, sliver, bronze):")
      item_name=imput("please enter the item you are buying:$")
      #calculate discount based on membership tier
      if tier.lower()=="gold"
         discount = 0.25
         elif tier.lower()=="sliver"
           discount=0.15
         elif tier.lower()== "bronze"
      else:
           print("invalid membership tier entered")
           # calcaulate new item price
           new_item_price = item_price * (1-discount)
           #display congratulatory message
           print ("congratulations,{name}! your {item_name}is now{new_item:2f}.Thank you for shopping with us.")
...
# sentences. 
technology has significantly impacted my learning in school by providing access to a vast array of educational resourcess and tools.
online research has made it easier to gather information for projects and assignments.
educational apps have offered interactive ways to practice.
but excessive screen time and distractions can also hinder focus and productivity.
...
technology can enhance learning experiences in various ways.educational apps and online platforms offer engaging content.enabling users to grasp complex concepts through multimedia elements
